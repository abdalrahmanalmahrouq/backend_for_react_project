                            ...
                            <div class="card-body">
                                ...
                                @csrf
                                        ...
                                        <label for="">Live Preview</label>
                                            <textarea class="form-control" name='live_preview' rows="4" id="comment"></textarea>
                                            @error('live_preview')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group">
                                           <img id ='showImage' src="{{ !empty($user->profile_photo_path)?url('upload/projects/'.$user->profile_photo_path):url('upload/no_image.jpg') }}" alt=" " style="width:100px;height:100px;">
                                        </div>
